...
https://github.com/Harris-Majeed/Hand-Tracking-Using-Opencv/assets/101493756/e0d7fae9-4a16-4639-b5fe-04d5c7f6ce38
...
1. **Clone the Repository**
   ...
   - Run the following command to clone the GitHub repository:
     ```
     git clone https://github.com/Harris-Majeed/Hand-Tracking-Using-Opencv.git
     ```
